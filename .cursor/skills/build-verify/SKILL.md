...
2. If build succeeds, report success and list changed files
3. If build fails:
   a. Read error output and identify file, line, and error type
...
- If 3 attempts fail, stop and report to the user
